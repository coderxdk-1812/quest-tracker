...
import { Plus, Trash2, CheckCircle2, Circle, CalendarIcon, X, Pencil, Search, Wand2 } from 'lucide-react';
              ...
              <div className="pt-1">
                {!showBreakdown ? (
                  ...
                  >
                    ...
                    Don't know where to start? Break it into steps
                  </Button>
                ) : (
                  <QuestBreakdown
                    taskId={editingId ?? 'draft-preview'}
                    title={form.title}
