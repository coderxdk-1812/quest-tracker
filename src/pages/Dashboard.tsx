...
export default function Dashboard() {
  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="max-w-5xl mx-auto space-y-6">
      ...
      {/* Streak at-risk (loss aversion) — owns the "live streak, not done today" case */}
      <motion.div variants={item}>
        <StreakStatusBanner />
      </motion.div>

      {/* Positive daily cue + zero-shame comeback — quiet when streak banner is showing */}
      <motion.div variants={item}>
        <DailyCue />
      </motion.div>
      ...
      {/* Quick stats (level, streak & XP live in the progression HUD above) */}
      <motion.div variants={item} className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          value={state.focusSessionsCompleted.toString()}
      ...
      {/* Mastery — per-subject competence framing */}
      <motion.div variants={item}>
        <MasteryCard />
      </motion.div>
