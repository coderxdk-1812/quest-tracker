...
/**
 * Positive daily cue + zero-shame comeback flow.
 * Stays quiet when you've worked today or when StreakStatusBanner already owns the
 * "streak at risk" case (live streak, not done today).
 */
